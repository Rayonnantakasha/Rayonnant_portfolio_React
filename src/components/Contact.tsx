    ...
    return (
        <section>
            ...
            <div className="mb-8 pr-12">
               <img src={logo} alt="mon logo" className="w-64 mx-auto"/>
            </div>
            
            <div className="mb-8">
              <h2 className="text-xl font-extrabold mb-4">CONTACTEZ-MOI</h2>
              <p className="text-lg text-gray-200">akasha.rayonnant@gmail.com</p>
            </div>
            <div>
              <h2 className="text-xl font-extrabold mb-4">SUIVEZ-MOI SUR</h2>
