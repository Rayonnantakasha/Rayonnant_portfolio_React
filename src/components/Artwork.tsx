...
function Artwork() {
    ...
    return (
        <section id='Artwork' className={`fade-in ${visible ? 'visible' : ''}`}>
             ...
             <div className='grid grid-cols-1 md:grid-cols-3 gap-8 px-32 py-32'>
             <div className="flex flex-col bg-[#38464B] shadow-2xs  ">
               <div className="p-4 md:p-10">
                 <h3 className="text-lg font-bold text-[#ff5940] pb-4 dark:text-white">
                    Application  Twitter X
                 </h3>
                 <p className="mt-2 text-gray-100 dark:text-neutral-400">
                 ...
                 <a className="mt-8 inline-flex items-center gap-x-1 text-sm font-bold bg-[#ff5940] p-4 hover:bg-orange-800 transition duration-300 ease-in-out " href="http://tweeter-clone-with-adonis-js-ray-production.up.railway.app">
                   VISITER LE SITE
                 </a>
               </div>
             </div>
             <div className="flex flex-col bg-[#38464B] shadow-2xs  ">
               <div className="p-4 md:p-10">
                 ...
                 <a className="mt-8 inline-flex items-center gap-x-1 text-sm font-bold bg-[#ff5940] p-4 hover:bg-orange-800 transition duration-300 ease-in-out " href="https://dev-fashion-akasha.pantheonsite.io/" target="_blank">
                   VISITER LE SITE
                 </a>
               </div>
             </div>
             <div className="flex flex-col bg-[#38464B] shadow-2xs  ">
               <div className="p-4 md:p-10">
                 ...
                 <a className="mt-8 inline-flex items-center gap-x-1 text-sm font-bold bg-[#ff5940] p-4 hover:bg-orange-800 transition duration-300 ease-in-out " href="#">
                   VISITER LE SITE
                 </a>
               </div>
             </div>
